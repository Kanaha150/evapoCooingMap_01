...
leaflet() %>% 
  addTiles() %>%
    addScaleBar()%>%
   addPolygons(data = nga, fillOpacity = 0)%>%
   addRasterImage( df_coolT_ng_2020_05 , colors = pal, opacity = 0.8) %>%
...
leaflet() %>% 
  addTiles() %>%
    addScaleBar()%>%
   addPolygons(data = ind, fillOpacity = 0)%>%
   addRasterImage( df_coolT_ind_2020_05 , colors = pal, opacity = 0.8) %>%
